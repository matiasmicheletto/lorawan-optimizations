...
OptimizationResults greedy13(Instance* l, Objective* o, uint iters, uint timeout, bool verbose){
    ...
    results2.cost = o->eval(gwBest2, sfBest2, results2.gwUsed, results2.energy, results2.uf, results.feasible);
